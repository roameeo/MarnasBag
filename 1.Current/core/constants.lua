...
---@enum BackpackTabPosition
const.BACKPACK_TAB_POSITION = {
  TOP = "top",
  SIDE = "side",
}

---@enum BackpackSidePosition
const.BACKPACK_SIDE_POSITION = {
  LEFT = "left",
  RIGHT = "right",
}

---@class MainBackpackGroupDef
---@field key string
---@field name string

---@type MainBackpackGroupDef[]
const.MAIN_BACKPACK_GROUPS = {
  { key = "equipment", name = "Equipment" },
  { key = "quest", name = "Quest items" },
  { key = "crafting", name = "Crafting items" },
...
const.DATABASE_DEFAULTS = {
  profile = {
    ...
    useMainCategoryTabs = true,
    backpackTabPosition = const.BACKPACK_TAB_POSITION.TOP,
    backpackSidePosition = const.BACKPACK_SIDE_POSITION.RIGHT,
    rememberBackpackSidePosition = true,
    ---@type table<string, number>
    mainBackpackGroups = {
      equipment = 1,
      quest = 2,
